...
namespace ModelView
{
	...
	// TreeModel::TreeModel(const QString &data, QObject *parent): 
		// QAbstractItemModel(parent)
	// {
		// root_ = new TreeItem({tr("Title"), tr("Summary")});
	...
	{
		std::cout << "TreeModel::data(" << index.row() << ',' << index.column() << ")" << std::endl;
		if (!index.isValid())
			return QVariant();
		...
		QVariant da(item-> data(index.column()));
		std::cout << "TreeModel::data() : The type is " << da.type() << std::endl;
